...
class _SettingsPageState extends State<SettingsPage> {
  ...
  //http://bit.ly/appnotex
  final Uri _reportProblem = Uri(
      scheme: 'mailto',
      path: 'ravikumar2710999@gmail.com',
      queryParameters: {
        'subject': kIsWeb ? 'Report_Problem_NoteX_Web' : 'Report_Problem_NoteX'
      });

  final Uri _contactMail = Uri(
      scheme: 'mailto',
      path: 'ravikumar2710999@gmail.com',
      queryParameters: {
        'subject': kIsWeb ? 'Hello_NoteX_Web' : 'Hello_NoteX_App'
      });

  String _whatsAppMessage = kIsWeb
      ? "https://wa.me/918433491441?text=Hello%20NoteX%20Web"
      : "https://wa.me/918433491441?text=Hello%20NoteX%20App";

  String _fbMessage = "https://m.me/theravikovind";
          ...
          children: [
            ListTile(
              title: Text(Theme.of(context).brightness == Brightness.light
                  ? "Dark Theme"
                  : "Light Theme"),
              trailing: Icon(Theme.of(context).brightness == Brightness.light
                  ? Icons.brightness_2
            ...
            ListTile(
              title: Text(!kIsWeb ? "NoteX Web" : "NoteX Application"),
              trailing: Icon(!kIsWeb ? Icons.language : Icons.android),
              onTap: () {
                kIsWeb
                    ? _launchURL("http://bit.ly/appnotex")
                    : _launchURL("https://notex-ravikovind.web.app");
              },
            ),
            ExpansionTile(
              ...
              children: [
                ...
                MaterialButton(
                    ...
                    onPressed: () {
                      _launchURL("https://ravikovind.github.io/me/");
                    },
                    child: const Text(
                      "Portfolio",
            ...
            ExpansionTile(
              ...
              trailing: Icon(Icons.contacts_rounded),
              children: [
                TextButton(
                    onPressed: () {
                      _launchURL(_contactMail.toString());
                    },
                    child: const Text("Mail")),
                TextButton(
                    onPressed: () {
                      _launchURL(_whatsAppMessage);
                    },
                    child: const Text("WhatsApp")),
                TextButton(
                    onPressed: () {
                      _launchURL(_fbMessage);
                    },
            ...
            ListTile(
              ...
              onTap: () {
                _launchURL(_reportProblem.toString());
              },
            ),
            ListTile(
            ...
            ListTile(
              ...
              trailing: const Icon(Icons.contact_page_rounded),
              onTap: () {
                showDialog(
                  context: context,
                  builder: (BuildContext context) {
